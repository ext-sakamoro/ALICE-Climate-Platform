...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['10 queries/hr', 'Basic climate model', '1 region', 'Community support'] },
  { name: 'Pro', price: '$49/mo', features: ['1,000 queries/hr', 'All models + forecast', 'Global regions', 'Anomaly detection', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited queries', 'Custom models', 'API priority access', 'SLA guarantee', 'Dedicated support'] },
];
