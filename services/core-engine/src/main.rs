...
async fn query(
    ...
    Json(QueryResponse {
        ...
        wind: WindData {
            speed_ms: wind_speed,
            direction_deg: wind_dir % 360.0,
        },
        cloud_cover_pct,
        precipitation_mm_h: precip_factor,
...
async fn anomaly_detect(
    ...
    for i in 0..anomaly_count {
        ...
        anomalies.push(Anomaly {
            ...
            description: format!(
                "{} detected at ({:.2}, {:.2}) with {:.1} sigma deviation",
                types[t_idx].replace('_', " "),
                lat,
                lon,
                sigma
            ),
...
async fn regions() -> Json<Vec<RegionInfo>> {
    Json(vec![
        RegionInfo {
            name: "Tokyo Metropolitan".into(),
            description: "Greater Tokyo Area, Japan".into(),
            lat_min: 35.5,
            lat_max: 35.9,
            lon_min: 139.4,
            lon_max: 140.0,
        ...
        RegionInfo {
            name: "North Atlantic".into(),
            description: "North Atlantic storm track region".into(),
            lat_min: 30.0,
            lat_max: 60.0,
            lon_min: -60.0,
            lon_max: -10.0,
        ...
        RegionInfo {
            name: "Sahara".into(),
            description: "Sahara Desert, heat anomaly monitoring".into(),
            lat_min: 15.0,
            lat_max: 35.0,
            lon_min: -15.0,
            lon_max: 40.0,
        ...
        RegionInfo {
            name: "Amazon Basin".into(),
            description: "Amazon rainforest humidity and deforestation monitoring".into(),
            lat_min: -10.0,
            lat_max: 5.0,
            lon_min: -75.0,
            lon_max: -45.0,
        ...
        RegionInfo {
            ...
            description: "Arctic ice monitoring and polar vortex tracking".into(),
            lat_min: 66.0,
            lat_max: 90.0,
            lon_min: -180.0,
            lon_max: 180.0,
        ...
        RegionInfo {
            ...
            description: "Monsoon patterns and tropical cyclone region".into(),
            lat_min: -10.0,
            lat_max: 25.0,
            lon_min: 95.0,
            lon_max: 140.0,
...
async fn stats(State(s): State<Arc<AppState>>) -> Json<StatsResponse> {
    ...
    Json(StatsResponse {
        ...
        total_anomalies_detected: st.total_anomalies_detected,
        total_forecasts: st.total_forecasts,
    })
}
